...
These back-ups work by using tags. In the [serverless.yaml](./serverless.yaml) you can see ResourceDBTable has a `backup - daily` & `service - fhir` tag. Anything with these tags will be backed-up daily at 5:00 UTC.
